-- Migration: Fix secure function conflict and ensure proper ES256 JWT integration
-- This migration properly handles the existing function and updates it for ES256

-- Drop existing secure function if it exists (with all possible signatures)
