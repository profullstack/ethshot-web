-- Create Authentication Policies for Shot Recording
-- 
-- This migration creates the necessary RLS policies to ensure that shot and winner
-- recording requires proper JWT authentication with wallet address validation.
